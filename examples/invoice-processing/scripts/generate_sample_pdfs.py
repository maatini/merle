...
def create_invoice_pdf(
    ...
    title_style = ParagraphStyle(
        "InvoiceTitle", parent=styles["Heading1"], fontSize=24, textColor=colors.HexColor("#1F4E79"), spaceAfter=20
    )
    meta_style = ParagraphStyle("InvoiceMeta", parent=styles["Normal"], fontSize=10, spaceAfter=6)
    ...
    meta_data = [
        [
            Paragraph(f"<b>Supplier:</b> {supplier}", meta_style),
            Paragraph(f"<b>Invoice ID:</b> {invoice_id}", meta_style),
        ],
        [
            Paragraph("<b>Address:</b> Business Park 4, Germany", meta_style),
...
def main() -> None:
    ...
    invoices = [
        ...
        },
        {
            ...
            "supplier": "Globex AG",
            "date": "2025-05-11",
            "items": [("Hardware components", 5, 150.00), ("Shipping & Handling", 1, 125.50)],
        },
        {
